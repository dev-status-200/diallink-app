...
const Create = ({appendCall, setVisible}) => {
    ...
    const handleSubmit = async(e) => {
        ...
        console.log(Object.keys(selectedVendor).length)
        await axios.post(process.env.NEXT_PUBLIC_DIALLINK_POST_CREATE_CALL,{
            name:name, contact:contact, city:city, address:address,start_date:start, end_date:end,
